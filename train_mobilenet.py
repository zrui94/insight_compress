...
def get_parser():
    ...
    parser.add_argument('--weight_decay', default=5e-4, help='learning alg momentum')
    ...
    parser.add_argument('--summary_path', default='./output/mobilenetv2-07151006/summary', help='the summary file save path')
    parser.add_argument('--ckpt_path', default='./output/mobilenetv2-07151006/ckpt', help='the ckpt file save path')
    parser.add_argument('--log_file_path', default='./output/mobilenetv2-07151006/logs', help='the ckpt file save path')
    ...
    parser.add_argument('--dim_eb', default=512)
...
if __name__ == '__main__':
    ...
    net_test = tf.squeeze(net_test, axis=[1,2])
    embedding_tensor = slim.fully_connected(net_test, num_outputs=args.dim_eb, activation_fn=None, reuse=True, scope='Logits/fc_last')
    ...
    print('########################')
    print('start restoring ori model')
    saver_restore.restore(sess, s_model_path)
    print('########################')
    print('model Mobilenet restored')
        ...
        while True:
            try:
                ...
                if count > 0 and count % args.ckpt_interval == 0:
                    filename = 'Mobile_iter_{:d}'.format(count) + '.ckpt'
