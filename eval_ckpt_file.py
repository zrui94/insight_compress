...
def get_args():
    ...
    parser.add_argument('--ckpt_file', default='/root/tensorflow/code/insight_compress/pretrained/InsightFace_iter_',
    ...
    parser.add_argument('--ckpt_index_list',
                        default=['175000.ckpt'], help='ckpt file indexes')
...
if __name__ == '__main__':
    ...
    net = get_resnet(images, args.net_depth, type='ir', w_init=w_init_method, trainable=False, keep_rate=0.5)
