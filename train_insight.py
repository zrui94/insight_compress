...
def get_parser():
    ...
    parser.add_argument('--summary_path', default='./output/MobileDistRes-07151040/summary', help='the summary file save path')
    parser.add_argument('--ckpt_path', default='./output/MobileDistRes-07151040/ckpt', help='the ckpt file save path')
    parser.add_argument('--log_file_path', default='./output/MobileDistRes-07151040/logs', help='the ckpt file save path')
...
if __name__ == '__main__':
    ...
    with graph_s.as_default():
        ...
        soft_loss_logit = tf.scalar_mul(10, tf.reduce_mean(tf.scalar_mul(0.5, tf.square(s_tau-t_tau_input))))
